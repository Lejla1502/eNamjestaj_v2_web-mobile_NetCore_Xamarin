...
namespace eNamjestaj.Data.Migrations
{
    ...
    [Migration("20210606191543_changeDostavaID_Int_To_String_in_Narudzbe")]
    partial class changeDostavaID_Int_To_String_in_Narudzbe
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eNamjestaj.Data.Models.KategorijaVrsta", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<int>("TopKategorijaId");

                    b.Property<int>("VrstaProizvodaId");

                    b.HasKey("Id");

                    b.HasIndex("TopKategorijaId");

                    b.HasIndex("VrstaProizvodaId");

                    b.ToTable("KategorijaVrsta");
                });
            ...
            modelBuilder.Entity("eNamjestaj.Data.Models.TopKategorija", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("eNamjestaj.Data.Models.KategorijaVrsta", b =>
                {
                    b.HasOne("eNamjestaj.Data.Models.TopKategorija", "TopKategorija")
                        .WithMany()
                        .HasForeignKey("TopKategorijaId")
                        .OnDelete(DeleteBehavior.Cascade);
