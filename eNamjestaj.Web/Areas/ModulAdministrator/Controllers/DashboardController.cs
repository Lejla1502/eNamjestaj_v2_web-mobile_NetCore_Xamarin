    ...
    public class DashboardController : Controller
    {
       private MojContext ctx;
        ...
        public IActionResult Index()
        {
            ...
            var brStavkiKataloga = ctx.KatalogStavka.Where(ks => ks.AkcijskiKatalogId == aktivniKatalog.Id).GroupBy(g => g.ProizvodId).ToList().Count();
           ...
           /* int sumUZadnja24Sata = 0;
            foreach (var l in listaIzlazaZadnja24Sata)
            {
                sumUZadnja24Sata += l.Count;
            }*/
